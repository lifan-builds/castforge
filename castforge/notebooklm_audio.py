...
【正文】
逐个讨论本周热帖，讲故事而不是干读数据。如果来源文档中有"精选回复"或社区讨论的具体内容，请自然地引用，比如"有老哥分享说……"、"底下有人吐槽……"、"一位网友的经验是……"。如果某个话题有争议，点出双方观点，让听众自己判断。

每个话题不要展开太多，但要有一个完整的"起-承-转"：这件事是什么→大家怎么看→有什么结论或实用信息。可自然使用美卡圈梗（5/24、史高、冥币、杀全家等），但不要编造事实。内容严格基于上传的来源文档。

【语气】
像两个老玩家聊天，不要播音腔，不要过度客套。偶尔可以互相调侃、表达个人倾向，让对话有温度。"""
