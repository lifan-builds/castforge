...
The repository declares offline tests and package building as native maintenance checks:
...
The test suite must remain offline and use fixture/fake provider clients. No lint or type-check command is declared; do not claim those checks passed.
