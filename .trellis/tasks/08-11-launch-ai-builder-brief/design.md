...
GitHub Actions schedules 13:00, 15:00, and 17:00 UTC (6, 8, and 10 AM Pacific during PDT). A date-keyed release marker and feed GUID make retries idempotent. Shadow mode writes artifacts only.
