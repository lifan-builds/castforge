...
_ENV_SESSION_KEYS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    # entry only fires once the resolver detected "zcode".
...
def _lookup_cursor_shell_ticket_context_key() -> str | None:
    ...
    export it into the shell command environment. The hook writes a short-lived
    ticket just before `task.py` runs. Only Cursor may consume these tickets.
    """
